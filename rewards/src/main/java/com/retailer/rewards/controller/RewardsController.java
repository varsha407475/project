...
public class RewardsController {
	...
	/*
	 * @GetMapping("/users",produces = MediaType.APPLICATION_JSON_VALUE) public
	 * List<Long> getusers(List<Long> user){ RewardsServiceImpl rimpl = new
	 * RewardsServiceImpl(); System.out.println(rimpl.getCustomers(null).size()); ;
	 * return rimpl.getCustomers(null); }
	 */
}
